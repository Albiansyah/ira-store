      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div className="md:col-span-1">
            <h3 className="text-lg font-semibold tracking-wide font-poppins mb-3">
              IRA STORE
            </h3>
            <p className="text-sm text-slate-400 font-inter leading-relaxed">
              E-Commerce Digital top #1 di Indonesia. Jual akun Gmail & digital access dengan pengiriman otomatis via WhatsApp.
            </p>
          </div>

          {/* Quick Links & Support - Sejajar di Mobile */}
          <div className="grid grid-cols-2 gap-6 md:col-span-2 md:gap-8">
            {/* Quick Links */}
            <div>
              <h4 className="text-sm font-semibold font-poppins mb-3 text-slate-300">
                Menu Cepat
              </h4>
        ...
        <div className="pt-6 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-slate-500 font-inter">
            © {currentYear} IRA STORE. All rights reserved.
          </p>
